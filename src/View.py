...
class View:
    ...
    def setup_layout(self):
        self.figure_frame.place(relx=0.4, rely=0.04, height=480, width=640)
        ...
        self.motor1_label.place(relx=0.005, rely=0.1, relheight=0.03)
        self.motor1_left_button.place(relx=0.04, rely=0.095, relheight=0.04, relwidth=0.04)
        self.motor1_right_button.place(relx=0.082, rely=0.095, relheight=0.04, relwidth=0.04)
        self.motor1_stop_button.place(relx=0.124, rely=0.095, relheight=0.04, relwidth=0.04)
        self.motor1_pwm_scale.place(relx=0.166, rely=0.085)
        self.motor1_timer_frame.place(relx=0.235, rely=0.085, relheight=0.06, relwidth=0.12)
        ...
        self.motor2_label.place(relx=0.005, rely=0.162, relheight=0.03)
        self.motor2_left_button.place(relx=0.04, rely=0.159, relheight=0.04, relwidth=0.04)
        self.motor2_right_button.place(relx=0.082, rely=0.159, relheight=0.04, relwidth=0.04)
        self.motor2_stop_button.place(relx=0.124, rely=0.159, relheight=0.04, relwidth=0.04)
        self.motor2_pwm_scale.place(relx=0.166, rely=0.15)
        self.motor2_timer_frame.place(relx=0.235, rely=0.15, relheight=0.06, relwidth=0.12)
        ...
        self.motor3_label.place(relx=0.005, rely=0.227, relheight=0.03)
        self.motor3_left_button.place(relx=0.04, rely=0.223, relheight=0.04, relwidth=0.04)
        self.motor3_right_button.place(relx=0.082, rely=0.223, relheight=0.04, relwidth=0.04)
        self.motor3_stop_button.place(relx=0.124, rely=0.223, relheight=0.04, relwidth=0.04)
        self.motor3_pwm_scale.place(relx=0.166, rely=0.215)
        self.motor3_timer_frame.place(relx=0.235, rely=0.215, relheight=0.06, relwidth=0.12)
        ...
        self.motor4_label.place(relx=0.005, rely=0.292, relheight=0.03)
        self.motor4_left_button.place(relx=0.04, rely=0.287, relheight=0.04, relwidth=0.04)
        self.motor4_right_button.place(relx=0.082, rely=0.287, relheight=0.04, relwidth=0.04)
        self.motor4_stop_button.place(relx=0.124, rely=0.287, relheight=0.04, relwidth=0.04)
        self.motor4_pwm_scale.place(relx=0.166, rely=0.28)
        self.motor4_timer_frame.place(relx=0.235, rely=0.28, relheight=0.06, relwidth=0.12)
        ...
        self.motor5_label.place(relx=0.005, rely=0.357, relheight=0.03)
        self.motor5_left_button.place(relx=0.04, rely=0.351, relheight=0.04, relwidth=0.04)
        self.motor5_right_button.place(relx=0.082, rely=0.351, relheight=0.04, relwidth=0.04)
        self.motor5_stop_button.place(relx=0.124, rely=0.351, relheight=0.04, relwidth=0.04)
        self.motor5_pwm_scale.place(relx=0.166, rely=0.345)
        self.motor5_timer_frame.place(relx=0.235, rely=0.345, relheight=0.06, relwidth=0.12)
