...
class LowerMotorFrame:
    def __init__(self, parent, identifier):
        ...
        self.motor1_timer_entry.insert(0, '1.0')
        ...
        self.motor2_timer_entry.insert(0, '1.0')
        ...
        self.motor3_timer_entry.insert(0, '1.0')
        ...
        self.motor4_timer_entry.insert(0, '1.0')
        ...
        self.motor5_timer_entry.insert(0, '1.0')
