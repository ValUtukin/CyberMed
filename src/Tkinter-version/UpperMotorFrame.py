...
class UpperMotorFrame:
    ...
    def setup_layout(self):
        ...
        self.motor2_right_button.place(relx=0.205, rely=0.14, relheight=0.08, relwidth=0.09)
        self.motor2_stop_button.place(relx=0.3, rely=0.14, relheight=0.08, relwidth=0.1)
        self.motor2_pwm_scale.place(relx=0.405, rely=0.11)
        self.motor2_timer_frame.place(relx=0.59, rely=0.11, relheight=0.159, relwidth=0.315)
        ...
        self.motor2_adc_checkbox.place(relx=0.91, rely=0.15)

        self.motor4_label.place(relx=0.005, rely=0.335, relheight=0.03)
        self.motor4_left_button.place(relx=0.09, rely=0.31, relheight=0.08, relwidth=0.11)
        self.motor4_right_button.place(relx=0.205, rely=0.31, relheight=0.08, relwidth=0.09)
        self.motor4_stop_button.place(relx=0.3, rely=0.31, relheight=0.08, relwidth=0.1)
        self.motor4_pwm_scale.place(relx=0.405, rely=0.28)
        self.motor4_timer_frame.place(relx=0.59, rely=0.275, relheight=0.159, relwidth=0.315)
        ...
        self.motor4_adc_checkbox.place(relx=0.91, rely=0.32)
        ...
        self.motor3_adc_checkbox.place(relx=0.91, rely=0.5)

        self.motor5_label.place(relx=0.005, rely=0.665, relheight=0.05)
        self.motor5_left_button.place(relx=0.09, rely=0.66, relheight=0.08, relwidth=0.11)
        self.motor5_right_button.place(relx=0.205, rely=0.66, relheight=0.08, relwidth=0.09)
        self.motor5_stop_button.place(relx=0.3, rely=0.66, relheight=0.08, relwidth=0.1)
        self.motor5_pwm_scale.place(relx=0.405, rely=0.62)
        self.motor5_timer_frame.place(relx=0.59, rely=0.615, relheight=0.159, relwidth=0.315)
        ...
        self.motor5_adc_checkbox.place(relx=0.91, rely=0.67)

        self.motor1_label.place(relx=0.005, rely=0.84, relheight=0.05)
        self.motor1_left_button.place(relx=0.09, rely=0.83, relheight=0.08, relwidth=0.11)
        self.motor1_right_button.place(relx=0.205, rely=0.83, relheight=0.08, relwidth=0.09)
        self.motor1_stop_button.place(relx=0.3, rely=0.83, relheight=0.08, relwidth=0.1)
        self.motor1_pwm_scale.place(relx=0.405, rely=0.795)
        self.motor1_timer_frame.place(relx=0.59, rely=0.785, relheight=0.159, relwidth=0.315)
...
if __name__ == '__main__':
    ...
    frame = UpperMotorFrame(root, 'Upper')
